...
export type CommentReactionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"commentId" | "userId" | "emoji" | "createdAt", ExtArgs["result"]["commentReaction"]>
...
export interface CommentReactionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const commentReactionWithCommentIdOnly = await prisma.commentReaction.findMany({ select: { commentId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many CommentReactions and only return the `commentId`
   * const commentReactionWithCommentIdOnly = await prisma.commentReaction.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more CommentReactions and only return the `commentId`
   * const commentReactionWithCommentIdOnly = await prisma.commentReaction.updateManyAndReturn({
   *   select: { commentId: true },
   *   where: {
   *     // ... provide filter here
   *   },
